...
const CleanWireframeAnalytics = () => {
    ...
    const currentData = (data as any)[selectedPeriod];
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-light">
            <div className="max-w-7xl mx-auto p-12">
                ...
                <div className="mb-16">
                    <h1
                        className={`text-6xl font-extralight text-gray-900 mb-4 tracking-tight transition-all duration-1000 ${animationPhase >= 1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                            }`}
                    >
                        Total Visitors
                    </h1>
                    <p
                        className={`text-xl text-gray-500 font-light transition-all duration-1000 delay-200 ${animationPhase >= 1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                            }`}
                    >
                ...
                <div className="relative bg-white rounded-none shadow-sm border-0">
                    ...
                    <div className="absolute top-8 left-8 z-10 flex gap-8">
                        <div
                            className={`flex items-center gap-2 transition-all duration-800 delay-300 ${animationPhase >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'
                                }`}
                        >
                        ...
                        <div
                            className={`flex items-center gap-2 transition-all duration-800 delay-400 ${animationPhase >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'
                                }`}
                        >
                ...
                `}
                        ...
                        <div className="h-96 relative">
                            <svg className="w-full h-full" viewBox="0 0 800 400">
                                    ...
                                    return (
                                        <g key={index}>
                                            ...
                                            <circle
                                                ...
                                                fill="#374151"
                                                className={`transition-all duration-500 cursor-pointer ${chartVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-0'
                                                    }`}
                                                style={{
                                                    transitionDelay: `${1200 + index * 100}ms`
                                                }}
                                                onMouseEnter={() => setHoveredPoint(index as any)}
                                ...
                                {hoveredPoint !== null && (
                                    <g>
                                        <rect
                                            x={60 + ((hoveredPoint as number) / (currentData.dates.length - 1)) * 680 - 50}
                                            y={20}
                                            width="100"
                                            height="70"
                                            fill="white"
                                        ...
                                        />
                                        <text
                                            x={60 + ((hoveredPoint as number) / (currentData.dates.length - 1)) * 680}
                                            y={38}
                                            textAnchor="middle"
                                            fill="#1f2937"
                                            fontSize="12"
                  ...
                  `}
                        ...
                        {/* Bundle Size */}
                        <div
                            className={`bg-gray-900 text-white px-6 py-3 rounded-lg transition-all duration-800 ${animationPhase >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                                }`}
                        ...
                        >
                            ...
                            <div className="w-48 h-2 bg-gray-700 rounded-full mt-2 overflow-hidden">
                                <div
                                    className={`h-full bg-gradient-to-r from-blue-500 via-green-500 to-orange-500 rounded-full transition-all duration-2000 ${chartVisible ? 'w-full' : 'w-0'
                                        }`}
